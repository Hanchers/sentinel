...
INSERT OR IGNORE INTO service_node (id,name,remark,status,cluster_id,health_check_method,health_check_cmd,restart_method,restart_cmd,create_time,update_time) VALUES
	 (1,'a_service','a服务','down',1,'bash','ping -c baidu.com','bash','ping -c baidu.com','2025-06-18 15:17:47','2025-06-18 15:17:47'),
	 (2,'b_service','b服务','down',2,'bash','ping -c baidu.com','bash','ping -c baidu.com','2025-06-18 15:20:50','2025-06-18 15:20:50'),
	 (3,'c_service','c服务','down',3,'bash','ping -c baidu.com','bash','ping -c baidu.com','2025-06-18 15:17:47','2025-06-18 15:17:47'),
	 (4,'d_service','d服务','down',4,'bash','ping -c baidu.com','bash','ping -c baidu.com','2025-06-18 15:20:50','2025-06-18 15:20:50'),
	 (5,'e_service','e服务','down',5,'bash','ping -c baidu.com','bash','ping -c baidu.com','2025-06-18 15:17:47','2025-06-18 15:17:47'),
	 (6,'f_service','f服务','down',6,'bash','ping -c baidu.com','bash','ping -c baidu.com','2025-06-18 15:20:50','2025-06-18 15:20:50');


-- 集群依赖关系
INSERT OR IGNORE INTO dependent_dag (id,source_cluster_id,target_cluster_id,create_time,update_time) VALUES
	 (1,'start','1','2025-06-18 14:59:20','2025-06-18 14:59:20'),
	 (2,'1','2','2025-06-18 14:59:20','2025-06-18 14:59:20'),
	 (3,'start','3','2025-06-18 14:59:20','2025-06-18 14:59:20'),
	 ...
	 (9,'6','end','2025-06-18 14:59:20','2025-06-18 14:59:20');
