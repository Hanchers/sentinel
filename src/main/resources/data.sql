...
INSERT OR IGNORE INTO service_node (id,name,remark,status,cluster_id,health_check_method,health_check_cmd,restart_method,restart_cmd,create_time,update_time) VALUES
	 ...
	 (6,'f_service','docker服务','down',6,'DOCKER_CHECKER','{"tcpHost":"tcp://192.168.202.102:2376","certPath":"certs","containerIdOrName":"postgres"}','DOCKER_CLIENT','{"tcpHost":"tcp://192.168.202.102:2376","certPath":"certs","containerIdOrName":"postgres","cmd":"start"}','2025-06-18 15:20:50','2025-06-18 15:20:50');
